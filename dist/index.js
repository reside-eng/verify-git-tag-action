...
module.exports = eval("require")("./packages/cider/package.json");
...
const remoteTags = __webpack_require__(665);
...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const tags = yield remoteTags('https://github.com/reside-eng/core-app-legacy.git');
            ...
            const { version } = __webpack_require__(210);
